...
<h2 class="has-text-align-center has-x-large-font-size"><?php esc_html_e( 'Page not found', 'enough' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php esc_html_e( 'It looks like nothing was found at this location. Maybe try a search?', 'enough' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group has-border-color has-transparent-border-color has-secondary-background-color has-background" style="border-radius:4px;border-style:solid">
	...
	<h2 class="has-text-align-left"><?php esc_html_e( 'Latest posts', 'enough' ); ?></h2>
	<!-- /wp:heading -->
